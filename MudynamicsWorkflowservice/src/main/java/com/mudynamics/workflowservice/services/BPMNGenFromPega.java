...
import com.mudynamics.workflowservice.models.DrawFlow;
import com.mudynamics.workflowservice.models.DrawShape;
import com.mudynamics.workflowservice.models.FlowNodeInfo;
import com.mudynamics.workflowservice.models.PegaToBPMNElement;
...
public class BPMNGenFromPega {
	...
	@Value("${pegaFilePath}")
	private String pegaFilePath;
	
	public String genBpmnFromPega(String inputFilePath) 
	{
		//File modelInstance = null;
  ...
  //  public static void main(String[] args) throws Exception {
        try {
           ...
           // File file = new File(args[0]);
        	String filePath=pegaFilePath+inputFilePath;
          ...
          //  File outputFile = new File(outputFilePath);
           // Bpmn.writeModelToFile(outputFile, modelInstance);
            ...
            System.out.println("Diagram " + inputFilePath+ " converted from Pega to Bpmn successfully ");

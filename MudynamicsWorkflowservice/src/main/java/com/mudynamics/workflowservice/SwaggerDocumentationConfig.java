	 ...
	 @Bean
	    public Docket customImplementation(){
	        return new Docket(DocumentationType.SWAGGER_2)
	                .select()
	                    .apis(RequestHandlerSelectors.basePackage("com.mudynamics.workflowservice"))
	                    .build()
	                 .apiInfo(apiInfo());
	    }
